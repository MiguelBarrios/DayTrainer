...
import com.miguelbarrios.stockservice.service.TDAService;
...
public class TDAController {
	...
	public String getQuote(@PathVariable String symbol, HttpServletResponse response) {
	...
	public String getQuotes(@PathVariable String symbols) {
